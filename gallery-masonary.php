<?php include 'header.php'?>        <!-- product section start here -->
		<div class="product-section masonary padding-tb">
				...
				<div class="section-wrapper">
					<div class="grid">
	    				<div class="product-item">
		    				<div class="product-inner">
		    					<div class="product-thumb">
		    						<img src="assets/images/masonary/01.jpg" alt="product">
								</div>
						...
						<div class="product-item">
		    				<div class="product-inner">
		    					<div class="product-thumb">
		    						<img src="assets/images/masonary/02.jpg" alt="product">
								</div>
								<div class="product-content">
						...
						<div class="product-item">
		    				<div class="product-inner">
		    					<div class="product-thumb">
		    						<img src="assets/images/masonary/03.jpg" alt="product">
								</div>
								<div class="product-content">
						...
						<div class="product-item">
		    				<div class="product-inner">
		    					<div class="product-thumb">
		    						<img src="assets/images/masonary/04.jpg" alt="product">
								</div>
								<div class="product-content">
						...
						<div class="product-item">
		    				<div class="product-inner">
		    					<div class="product-thumb">
		    						<img src="assets/images/masonary/05.jpg" alt="product">
								</div>
								<div class="product-content">
						...
						<div class="product-item">
		    				<div class="product-inner">
		    					<div class="product-thumb">
		    						<img src="assets/images/masonary/06.jpg" alt="product">
								</div>
								<div class="product-content">
									<a href="#" class="product-name">Fruits</a>
								</div>
						...
						<div class="product-item">
		    				<div class="product-inner">
		    					<div class="product-thumb">
		    						<img src="assets/images/masonary/07.jpg" alt="product">
								</div>
								<div class="product-content">
						...
						<div class="product-item">
		    				<div class="product-inner">
		    					<div class="product-thumb">
		    						<img src="assets/images/masonary/08.jpg" alt="product">
								</div>
								<div class="product-content">
						...
						<div class="product-item">
		    				<div class="product-inner">
		    					<div class="product-thumb">
		    						<img src="assets/images/masonary/09.jpg" alt="product">
								</div>
								<div class="product-content">
						...
						<div class="product-item">
		    				<div class="product-inner">
		    					<div class="product-thumb">
		    						<img src="assets/images/masonary/10.jpg" alt="product">
								</div>
								<div class="product-content">
									<a href="#" class="product-name">Cows</a>
								</div>
						...
						<div class="product-item">
		    				<div class="product-inner">
		    					<div class="product-thumb">
		    						<img src="assets/images/masonary/11.jpg" alt="product">
								</div>
								<div class="product-content">
									<a href="#" class="product-name">Cows</a>
								</div>
						...
						<div class="product-item">
		    				<div class="product-inner">
		    					<div class="product-thumb">
		    						<img src="assets/images/masonary/12.jpg" alt="product">
								</div>
								<div class="product-content">
									<a href="#" class="product-name">Cows</a>
								</div>
...
<!-- Mirrored from labartisan.net/demo/chashi/gallery-masonary.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Aug 2020 05:28:58 GMT -->
</html>