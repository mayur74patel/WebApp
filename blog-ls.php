                    ...
                    <div class="row justify-content-center flex-row-reverse">
                        <div class="col-lg-9 col-12">
                            <article>
                                <div class="post-item-2">
									<div class="post-inner">
										...
										<div class="post-content">
											...
											<a href="blog-single.php"><h3>Continually proactive services</h3></a>
											...
											<div class="d-flex flex-wrap justify-content-between more-com">
												<div class="text-btn">
													<a href="blog-single.php"><span>Read More<i class="fa fa-angle-double-right"></i></span></a>
												</div>
								...
								<div class="post-item-2 quite-post">
									<div class="post-inner">
										<div class="post-content">
